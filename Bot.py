import time;print('Protected by Savion & Ninja with ChaCha20');time.sleep(2.5)
import requests
import json
import time
import threading
...
# Display logo
def display_logo():
    logo_text = Text(" Adsm Evm ", style="bold yellow", justify="center")
    team_text = Text("CryptoBotscript Team\n@Morasamii | @hamedmo20 | @L2025k", style="bold green", justify="center")
    footer_text = Text("© Ke4oo  |  Telegram: https://t.me/YOU742", style="cyan", justify="center")
    combined_text = logo_text + Text("\n\n") + team_text + Text("\n") + footer_text
    panel = Panel(combined_text, title="🚀 LOGO 🚀", border_style="red", width=90)
    console.print(panel)
